...
def getWeather():
    try:
        ...
        # weather
        api = "https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=0939196fa24fdb0a34470cc229abf7a4"
...
textfield = tk.Entry(
    root, justify="center", width=17, font=("poppins", 25, "bold"),
...
myimage_icon = tk.Button(
    image=Search_icon, borderwidth=0, cursor="hand2", bg="#404040",
    command=getWeather)
...
# label
label1 = tk.Label(
    root, text="WIND", font=("Helvetica", 15, 'bold'),
    fg="white", bg="#1ab5ef")
...
label3 = tk.Label(
    root, text="DESCRIPTION", font=("Helvetica", 15, 'bold'),
    fg="white", bg="#1ab5ef")
